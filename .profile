...
# apply ansible environment - No longer in use
# alias apply-env='ansible -K localhost -c local -m include_role -a name=jaswinford.env'

# Pomodoro timers - Doesn't work anymore. Need to replace.
